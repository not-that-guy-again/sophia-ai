                    ...
                    "candidates": [
                        {
                            ...
                            "parameters": {
                                "order_id": "ORD-12345",
                                "reason": "Customer received damaged product",
                            },
            ...
            json.dumps(
                {
                    "candidates": [
                        ...
                        },
                        {
                            ...
                            "parameters": {
                                "reason": "Free product request",
                                "priority": "medium",
                                "context_summary": "Customer asking for a free PS5",
                            },
...
async def test_conversational_input_bypasses_pipeline(
    ...
    loop.hat_registry = __import__("sophia.hats.registry", fromlist=["HatRegistry"]).HatRegistry(
...
async def test_yellow_tier_confirmation(
    ...
    results = [
        ...
        EvaluatorResult(
            evaluator_name="tribal", score=-0.2, confidence=0.7, reasoning="minor concern"
        ),
        EvaluatorResult(
            evaluator_name="domain",
            score=-0.4,
            confidence=0.85,
            reasoning="near policy edge",
            flags=["refund_exceeds_authority"],
        ),
        EvaluatorResult(
            evaluator_name="authority", score=-0.1, confidence=0.8, reasoning="standard"
        ),
    ]
